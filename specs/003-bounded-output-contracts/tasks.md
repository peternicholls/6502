...
- [ ] T005 Add a failing public-shape contract for owned results, capacities 3/4,096, 48 kHz mono Float32, and diagnostic counters in `Tests/C2/test-public-boundaries.sh`
...
- [ ] T008 [P] [US1] Add failing frame FIFO, oldest-first dequeue, drop-oldest, monotonic-number, and accounting tests in `Tests/test_main.cpp`
...
- [ ] T026 [P] [US3] Add failing diagnostic consistency, depth/capacity, demand, pressure-counter, and cycle-observation tests in `Tests/test_main.cpp`
