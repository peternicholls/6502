...
**Verdict**: Remediated; every item is linked to its closing task evidence.
...
- [x] **IDC-001 Make the private/internal documentation requirement enforceable.**
  **Closure**: [T065](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `d846c55`; branch-aware internal and public debt gates plus the undocumented-internal negative fixture passed.
...
- [x] **IDC-002 Correct and complete the C 0.2 declaration contracts.**
  **Closure**: [T047](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `1442a2d`; the declaration-driven C matrix, strict header compile, public-boundary suite, and docs gate passed.
...
- [x] **IDC-003 State concurrency and callback contracts for public device types.**
  **Closure**: [T052](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `e37663b`; all seven generated device declarations and `git diff --check` passed.
...
- [x] **IDC-004 Replace the CPU private-interface TODO with useful maintainer documentation.**
  **Closure**: [T053](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `d5e667e`; generated CPU documentation and the strict docs gate passed with no TODO remaining.
...
- [x] **IDC-005 Document the 8271 private state vocabulary.**
  **Closure**: [T053](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `d5e667e`; `Status`/`Transfer` responsibilities passed the branch-aware internal declaration check.
...
- [x] **IDC-006 Complete the Swift input contracts.**
  **Closure**: [T050](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `4428cc9`; Swift DocC generation, input-bound contracts, and throwing-contract negative fixtures passed.
...
- [x] **IDC-007 Document the demo's internal UI boundaries.**
  **Closure**: [T054](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `f5525fb`; Swift build/DocC and branch-aware declaration checks passed.
...
- [x] **IDC-008 Document the Swift test-suite boundary.**
  **Closure**: [T054](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `f5525fb`; Swift test compilation and documentation validation passed.
...
- [x] **IDC-009 Document the C++ test harness and decimal-vector schema.**
  **Closure**: [T055](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `6e193bf`; strict docs generation and core test compilation passed.
...
- [x] **IDC-010 Document the C1 replay evidence aggregates.**
  **Closure**: [T055](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `6e193bf`; the replay contract and generated internal documentation gate passed.
...
- [x] **IDC-011 Document evidence-tool configuration and ownership types.**
  **Closure**: [T056](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `c2f68c6`; strict evidence-tool build and docs gate passed.
...
- [x] **IDC-012 Document headless-host ownership and its functional-test bus.**
  **Closure**: [T056](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `c2f68c6`; strict headless build and docs gate passed.
...
- [x] **IDC-013 Document the clean-room ROM builder abstraction.**
  **Closure**: [T056](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `c2f68c6`; strict demo-ROM tool build and docs gate passed.
...
- [x] **IDC-014 Record the C-handle admission and destruction invariants near the code.**
  **Closure**: [T051](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `3f04653`; public-boundary, Swift lifetime, build, and docs gates passed.
...
- [x] **IDC-015 Document NMOS CPU edge semantics and their authority.**
  **Closure**: [T057](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `68087f7`; indirect-JMP and exhaustive decimal/vector CPU tests passed.
...
- [x] **IDC-016 Add one authoritative CPU transition and opcode-timing rationale.**
  **Closure**: [T057](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `68087f7`; branch, interrupt, RMW, opcode, and timing tests plus `git diff --check` passed.
...
- [x] **IDC-017 Document the CRTC register mask/read-visibility table.**
  **Closure**: [T058](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `1199003`; focused CRTC timing/register and docs checks passed.
...
- [x] **IDC-018 Document DFS image geometry and interleave provenance.**
  **Closure**: [T058](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `1199003`; SSD/DSD layout and documentation checks passed.
...
- [x] **IDC-019 Add an 8271 protocol and aggregate-timing rationale.**
  **Closure**: [T059](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `37f3d15`; 8271 protocol and BBC wiring tests passed.
...
- [x] **IDC-020 Document aggregate BBC hardware wiring and rendering rules.**
  **Closure**: [T059](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `37f3d15`; memory-map, bitmap, keyboard, and 8271 aggregate tests passed.
...
- [x] **IDC-021 Document the sound-chip protocol and approximation limits.**
  **Closure**: [T060](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `c5c70d5`; SN76489 protocol/rendering and docs checks passed.
...
- [x] **IDC-022 Document teletext provenance and modeled control behavior.**
  **Closure**: [T060](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `c5c70d5`; clean-room teletext/control-cell and docs checks passed.
...
- [x] **IDC-023 Document VIA register side effects and timer/edge transitions.**
  **Closure**: [T060](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `c5c70d5`; VIA timer, interrupt, port, and edge tests passed.
...
- [x] **IDC-024 Complete the Video ULA rationale.**
  **Closure**: [T060](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `c5c70d5`; video palette/bitmap and docs checks passed.
...
- [x] **IDC-025 Replace syntax-translation comments in hardware fixtures.**
  **Closure**: [T061](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `328270d`; hardware fixture, runtime, replay, race, and docs gates passed.
...
- [x] **IDC-026 Add a section rationale for the C1 concurrency fixtures.**
  **Closure**: [T061](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `328270d`; lifecycle, FIFO, replay, deadline, and shutdown tests passed.
...
- [x] **IDC-027 Document the evidence file schemas at serialization.**
  **Closure**: [T062](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `95e7560`; exact evidence/reference and strict tool-build checks passed.
...
- [x] **IDC-028 Explain how generated demo ROMs produce deterministic evidence.**
  **Closure**: [T062](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `95e7560`; deterministic demo-ROM, exact reference, and strict build checks passed.
...
- [x] **IDC-029 Document documentation-builder temporary-file ownership.**
  **Closure**: [T063](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `3e6b292`; shell syntax and documentation negative fixtures passed.
...
- [x] **IDC-030 Link the changed-complex-code gate to its governing rule.**
  **Closure**: [T063](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `3e6b292`; rationale-marker and reviewed-N/A negative fixtures passed.
...
- [x] **IDC-031 Explain interrupted measurement-record persistence.**
  **Closure**: [T064](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `aa79d37`; shell syntax and measurement interruption/classification contracts passed.
...
- [x] **IDC-032 Explain locale-stable reference verification.**
  **Closure**: [T064](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `aa79d37`; shell syntax and exact-reference ordering verification passed.
...
- [x] **IDC-033 Explain failure-retaining aggregate verification.**
  **Closure**: [T064](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `aa79d37`; aggregate failure-propagation and verifier shell checks passed.
...
- [x] **IDC-034 Explain why the TSan support probe must execute.**
  **Closure**: [T064](tasks.md#remediation-ledger-code-and-inline-documentation-audits), commit `aa79d37`; executable-probe syntax, normal race lane, and honest unsupported-host reporting passed.
