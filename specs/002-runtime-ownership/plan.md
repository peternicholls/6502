...
the next task. The final task in every phase records phase completion; no empty
...
**Scale/Scope**: One runtime per machine, four lifecycle states, twelve command
...
- [x] Every task and phase has focused verification and a Lore commit checkpoint.
